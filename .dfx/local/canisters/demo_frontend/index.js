...
import { idlFactory } from './demo_frontend.did.js';
export { idlFactory } from './demo_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEMO_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./demo_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the demo_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./demo_frontend.did.js")._SERVICE>}
 */
export const demo_frontend = createActor(canisterId);
