...
import { idlFactory } from './demo_backend.did.js';
export { idlFactory } from './demo_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEMO_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./demo_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the demo_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./demo_backend.did.js")._SERVICE>}
 */
export const demo_backend = createActor(canisterId);
